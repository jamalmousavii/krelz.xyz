...
- **Chat Source Badge (v3.18.1)** — each reply shows `⛏️ via miner` / `⚡ via provider` / `💻 local`
- **Default Model (v3.18.1)** — chat defaults to `llama3.1:8b` (online miner); `free-cloud-ai` always available
